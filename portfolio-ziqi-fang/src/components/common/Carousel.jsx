  ...
  return (
    <div className="max-w-2xl overflow-hidden relative rounded-md group">
      ...
      <div className="absolute inset-0 flex items-center justify-between p-4">
        <button
          onClick={prev}
          className="p-1 rounded-full shadow bg-white/80 text-gray-500 drop-shadow-sm transition duration-200 hover:bg-white hover:-translate-y-1 hover:scale-105 hover:drop-shadow-md"
        >
      ...
      <div className="opacity-0 drop-shadow-sm flex flex-col absolute inset-8 md:inset-32 items-center justify-center p-1 bg-white rounded-lg darkMode-color group-hover:opacity-100 transition duration-300 delay-75 group-hover:drop-shadow-xl">
        <p className="text-sm md:tracking-wide md:text-lg md:p-4">
          {slides[curr].projName}
        </p>
        <p className="text-xs md:tracking-wide md:text-sm md:p-2">
          {slides[curr].description}
        </p>
        <a
          href={slides[curr].link}
          className="text-md cursor-pointer duration-150 hover:scale-110 m-4"
          target="_blank"
