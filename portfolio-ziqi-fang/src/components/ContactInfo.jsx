...
const ContactInfo = () => {
  ...
  return (
    <Section
      title="📩 Contact Me 📩"
      subtitle="I am open to talk regarding freelancing or full-time oppurtinities. Hope to hear from you soon!"
    >
      <div className="flex flex-col items-center justify-center gap-8 text-center">
        ...
        <div>
          <p className="max-w-xs md:max-w-lg font-extralight">
            Please email me directly for the fastest response! My email address
            is: zfang1207@gmail.com. Thank you!
          </p>
        </div>
        <div className="flex w-full items-center justify-evenly text-3xl">
          {SOCIAL.map(({ id, link, icon }) => (
            <a
              ...
              className="duration-200 ease-in-out hover:text-amber-200"
            >
              {icon}
            </a>
          ))}
        ...
        {/* <div className="p-8 text-left w-full">
          <form
            action="https://getform.io/f/ff792e36-dfdc-417e-a98f-6b318e2812f0"
            method="POST"
          >
            <div className="flex flex-col gap-4 w-full">
              ...
              <div className="flex flex-col">
                ...
                <textarea
                  ...
                  spellCheck="false"
                  placeholder="Please leave a message so I can reply back. Thank you for your interest! 🙏🏻"
                ></textarea>
              </div>
            </div>
