...
import portfolio2D from "../assets/2dAvatar.png";

const Profile_Avatar = ({ profile_photo }) => {
  return (
    <div className="wrapper flex justify-center items-center min-h-0 overflow-hidden relative">
      {/* Outer Ring */}
      {/* color palatte:
          1. Dark Mode: bg-black before:from-[#d400d4] before:to-[#00ccff]
         */}
      <div
        className='overflow-hidden w-64 h-64 sm:w-80 sm:h-80 relative rounded-full
      ...
      >
        {/* Inner Ring */}
        <div
          className="content absolute border-[#dacdb5] border-[6px] z-20 rounded-full inset-6 overflow-hidden
        ...
        >
          ...
          <h2 className="text-center font-semibold text-lg tracking-wide relative">
            Ziqi Fang
          </h2>
          <span className="m-2 font-light text-sm tracking-normal relative">
            Now Actively Applying!
          </span>
          <a
            href="https://linkedin.com/in/ziqi-fang"
            target="_blank"
