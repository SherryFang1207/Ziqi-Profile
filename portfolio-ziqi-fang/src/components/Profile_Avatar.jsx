...
const Profile_Avatar = ({profile_photo}) => {
  return (
    <div className='wrapper flex justify-center items-center min-h-0 overflow-hidden relative'>
         ...
         */}
        <div className='overflow-hidden w-64 h-64 sm:w-80 sm:h-80 relative rounded-full
        ...
        after:content-[""] after:absolute after:inset-2 after:bg-yellow-100 after:rounded-full after:z-10
