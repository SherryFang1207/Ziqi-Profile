...
import ios_Swift from "../assets/icons8-swift.svg";
import ios_SwiftUI from "../assets/icons8-swiftui.svg";
import ios_XCode from "../assets/icons8-xcode.svg";
...
const Tech = () => {
  return (
    <Section
      title="Tech Stack"
      subtitle="From prototyping to production deploying, every indispensable step surely make a difference. 🦄"
    >
      ...
      <div className="grid w-5/6 grid-cols-3 sm:w-3/4 sm:grid-cols-4 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 md:w-3/5 gap-6 md:gap-8">
        ...
        {/* iOS Development: 1. Swift 2. SwiftUI 3. Xcode */}
        <TechCard icon={ios_Swift} title="Swift" />
        <TechCard icon={ios_SwiftUI} title="SwiftUI" />
        <TechCard icon={ios_XCode} title="XCode" />
      </div>
    </Section>
  );
};
